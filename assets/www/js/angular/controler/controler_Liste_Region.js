...
//  appelle template ajouter ipes
        ...
        $scope.ajouter_option = function()
        {
           ...
           //  appelle template ajouter un programme académique
        $scope.ajouter_programme = function()
        {
            // alert('tokus');
            window.loggedIn = 'add_programme_academique';
        }
...
//        }
         ...
         //appelle template recherche all etab        
...
//appelle template lire annonce d'un ipes       
    ...
    }]).controller('operation_diplome', ['$scope', 'service_Add_diplome', 'service_Add_etab', '$timeout', function($scope, service_Add_diplome, service_Add_etab, $timeout)
    {
        ...
        $scope.save_diplome = function()
        {
            ...
            data_diplome.presentation = $scope.presentation;
    ...
    }]).controller('operation_filiere', ['$scope', 'service_Add_filiere', 'service_Add_etab', '$timeout', function($scope, service_Add_filiere, service_Add_etab, $timeout)
    {
        ...
        $scope.save_filiere = function()
        {
            ...
            data_filiere.tutelle = $scope.tutelle;
             data_filiere.presentation = $scope.presentation;
    ...
    }]).controller('operation_specialite', ['$scope', 'service_Add_specialite', 'service_Add_etab', '$timeout', function($scope, service_Add_specialite, service_Add_etab, $timeout)
    {
        ...
        $scope.save_specialite = function()
        {
           ...
           data_specialite.presentation = $scope.presentation;
...
//
//            data_specialite.date_CCJ = $scope.date_CCJ;
//
...
//            data_specialite.date_CCS = $scope.date_CCS;
//
...
//
    ...
    }]).controller('operation_programme_académique', ['$scope', 'service_Add_programme','service_Add_etab','$timeout', function($scope, service_Add_programme,service_Add_etab,$timeout)
    {
      ...
      // charge le nom des specialite en fonction des filieres choisies
        ...
        data_programme.specialite_filiere = null;

        //on recupere le nom de la specialité selectionnée

        $scope.update8 = function(specialite_filiere)
        {
            data_programme.specialite_filiere = specialite_filiere.labelle_specialite;
        }

   
        $scope.save_programme = function()
        {



            data_programme.etat_programme = $scope.etat_programme;
             data_programme.annee = $scope.annee;
            
            data_programme.duree_formation = $scope.duree_formation;
            data_programme.prerequis = $scope.prerequis;

            data_programme.forme_suivi = $scope.forme_suivi;
            data_programme.cour_jour = $scope.cour_jour;
           data_programme.inscription_CJ = $scope.inscription_CJ;

           data_programme.pension_CJ = $scope.pension_CS;
            data_programme.date_CJ = $scope.date_CS;

           data_programme.date_CCJ = $scope.date_CCJ;

            data_programme.cour_soir = $scope.cour_soir;
            data_programme.inscription_CS = $scope.inscription_CS;

            data_programme.pension_CS = $scope.pension_CS;
            data_programme.date_CS = $scope.date_CS;
            data_programme.date_CCS = $scope.date_CCS;

            
        
            service_Add_programme.serverRequest(data_programme, $scope);
